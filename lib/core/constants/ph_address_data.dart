// lib/core/constants/ph_address_data.dart
// Philippine provinces and their cities/municipalities

const Map<String, List<String>> phAddressData = {
  // ── Metro Manila (NCR) ───────────────────────────────────────────────────────
  'Metro Manila': [
  ...
  'Abra': [
    ...
    'Pilar', 'Sal-Lapadan', 'San Isidro', 'San Juan', 'San Quintin',
  ...
  'Ifugao': [
    ...
    'Hungduan', 'Kiangan', 'Lagawe', 'Lamut', 'Litbeng', 'Mayoyao',
    'Tinoc',
  ],
  'Kalinga': [
    'Balbalan', 'Lubuagan', 'Pasil', 'Pinukpuk', 'Rizal', 'Tabuk City',
    'Tanudan', 'Tinglayan',
  ],
  'Mountain Province': [
  ...
  'La Union': [
    ...
    'San Fernando City', 'San Gabriel', 'San Juan', 'Santo Tomas',
  ...
  'Pangasinan': [
    ...
    'Natividad', 'Pozzorubio', 'Rosales', 'San Carlos City', 'San Fabian',
  ...
  'Bulacan': [
    ...
    'Malolos City', 'Marilao', 'Meycauayan City', 'Norzagaray',
  ...
  'Nueva Ecija': [
    ...
    'Lupao', 'Munoz City', 'Nampicuan', 'Palayan City', 'Pantabangan',
  ...
  'Pampanga': [
    ...
    'Guagua', 'Lubao', 'Mabalacat City', 'Macabebe', 'Magalang',
    'Masantol', 'Mexico', 'Minalin', 'Porac', 'San Fernando City',
  ...
  'Batangas': [
    ...
    'Santa Teresita', 'Santo Tomas', 'Taal', 'Talisay', 'Tanauan City',
    'Taysan', 'Tingloy', 'Tuy',
  ],
  'Cavite': [
  ...
  'Laguna': [
    ...
    'Rizal', 'San Pablo City', 'San Pedro City', 'Santa Cruz',
  ...
  'Palawan': [
    ...
    'El Nido', 'Española', 'Kalayaan', 'Linapacan', 'Magsaysay',
    'Narra', 'Puerto Princesa City', 'Quezon', 'Rizal', 'Roxas',
  ...
  'Leyte': [
    ...
    'MacArthur', 'Mahaplag', 'Matag-ob', 'Matalom', 'Mayorga',
    'Merida', 'Omoa', 'Ormoc City', 'Palo', 'Palompon', 'Pastrana',
  ...
  'Northern Samar': [
    ...
    'San Isidro', 'San Jose', 'San Roque', 'San Vicente', 'Silvino Lubos',
    'Victoria',
  ],
  'Samar': [
  ...
  'Southern Leyte': [
    ...
    'San Juan', 'San Ricardo', 'Silago', 'Sogod', 'St. Bernard',
    'Tomas Oppus',
  ],
  ...
  'Zamboanga del Norte': [
    ...
    'Polanco', 'Pres. Manuel A. Roxas', 'Rizal', 'Salug', 'San Miguel',
    'San Pablo', 'Sergio Osmeña Sr.', 'Siayan', 'Sibuco', 'Sibutad',
  ...
  'Zamboanga del Sur': [
    ...
    'Lapuyan', 'Mahayag', 'Margosatubig', 'Midsalip', 'Molave',
    'Pagadian City', 'Pitogo', 'Ramon Magsaysay', 'San Miguel',
    'San Pablo', 'Tabina', 'Tambulig', 'Tigbao', 'Tukuran',
    'Vincenzo A. Sagun', 'Zamboanga City',
  ],
  'Zamboanga Sibugay': [
  ...
  'Lanao del Norte': [
    ...
    'Maigo', 'Munai', 'Nunungan', 'Pantao Ragat', 'Pantar',
  ...
  'Davao del Sur': [
    'Bansalan', 'Davao City', 'Digos City', 'Hagonoy', 'Jose Abad Santos',
  ...
  'Cotabato': [
    ...
    'Makilala', 'Matalam', 'Midsayap', 'Pigkawayan', 'Pikit',
  ...
  'Agusan del Sur': [
    ...
    'Rosario', 'San Francisco', 'San Luis', 'Santa Josefa', 'Santo Tomas',
  ...
  'Lanao del Sur': [
    'Amai Manabilang', 'Bacolod-Kalawi', 'Balabagan', 'Balindong',
    'Bayang', 'Binidayan', 'Buadiposo-Buntong', 'Bubong', 'Bumbaran',
    'Butig', 'Calanogas', 'Ditsaan-Ramain', 'Ganassi', 'Kapai',
    'Kapatagan', 'Lumba-Bayabao', 'Lumbaca-Unayan', 'Lumbatan',
    'Lumbayanague', 'Madalum', 'Madamba', 'Maguing', 'Malabang',
    'Marantao', 'Marawi City', 'Marogong', 'Masiu', 'Molundo',
    'Mulondo', 'Pagayawan', 'Piagapo', 'Picong', 'Poona Bayabao',
  ...
  'Maguindanao del Sur': [
    ...
    'Datu Saudi-Ampatuan', 'Datu Unsay', 'Gen. Salipada K. Pendatun',
  ...
  'Sulu': [
    ...
    'Languyan', 'Lapa-Lapa', 'Lugus', 'Luuk', 'Maimbung', 'Old Panamao',
    'Omar', 'Pandami', 'Panglima Estino', 'Parang', 'Pata',
...
List<String> get phProvinces => phAddressData.keys.toList()..sort();

List<String> citiesFor(String province) =>
    List<String>.from(phAddressData[province] ?? [])..sort();
