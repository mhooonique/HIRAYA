...
//
// Shown when user taps a DUMMY product — full info view, no real interactions.
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: const Row(children: [
                      ...
                      Expanded(
                        child: Text(
                          'This is a showcase post. '
                          'Sign in to interact with real innovations.',
                          style: TextStyle(
                              fontFamily: 'Poppins',
                              fontSize: 12,
                              color: AppColors.golden),
                  ...
                  // Innovator card (no message button)
                  Container(
                    ...
                    child: Row(children: [
                      ...
                      Expanded(child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(p.innovatorName,
                              style: TextStyle(
                                  fontFamily: 'Poppins',
                                  fontSize: 15,
                                  fontWeight: FontWeight.w700,
                                  color: primaryText)),
                          Text('@${p.innovatorUsername}',
                              style: TextStyle(
                                  fontFamily: 'Poppins',
                                  fontSize: 13,
                                  color: isDark
                  ...
                  if (p.images.isNotEmpty) ...[
                    ...
                    _buildLabel('Gallery', Icons.photo_library_rounded,
                        primaryText),
                  ...
                  // Video demo button
                  if (p.videoBase64 != null &&
                      p.videoBase64!.isNotEmpty) ...[
                    const SizedBox(height: 24),
                    _buildLabel(
                        'Video Demo', Icons.videocam_rounded, primaryText),
                    const SizedBox(height: 12),
                    GestureDetector(
                  ...
                  if (p.externalLink != null &&
                      p.externalLink!.isNotEmpty) ...[
                    const SizedBox(height: 24),
                    _buildLabel(
                        'Learn More', Icons.link_rounded, primaryText),
                    const SizedBox(height: 12),
                    GestureDetector(
      ...
      Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Row(children: [
              _HeroStat(Icons.favorite_rounded,
                  '${p.likes}', 'Likes'),
              const SizedBox(width: 20),
              _HeroStat(Icons.remove_red_eye_rounded,
                  '${p.views}', 'Views'),
              const SizedBox(width: 20),
