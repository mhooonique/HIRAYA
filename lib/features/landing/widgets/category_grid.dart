...
class _CategoryGridState extends State<CategoryGrid>
  ...
  static const List<Map<String, dynamic>> _categories = [
    {
      'name': 'Agri-Aqua and Forestry',
      'icon': Icons.grass_rounded,
      'color': AppColors.teal,
      'desc': 'Northern Mindanao raw-material innovations — smart farming, aquaculture, and forestry with yield/waste impact highlights.',
      'count': 42,
      'tag': 'Most Active',
    },
    {
      'name': 'Food Processing and Nutrition',
      'icon': Icons.restaurant_menu_rounded,
      'color': Color(0xFFFF8C42),
      'desc': 'MSME-ready processing technologies focused on shelf-life extension, nutrient retention, and FDA compliance readiness.',
      'count': 36,
      'tag': 'MSME Focus',
    },
    {
      ...
      'desc': 'Tuklas Lunas-aligned diagnostics, biomedical tools, and telehealth innovations with clinical validation status.',
      'count': 38,
      'tag': 'High Demand',
    },
    {
      'name': 'Energy, Utilities, and Environment',
      'icon': Icons.bolt_rounded,
      'color': AppColors.golden,
      'desc': 'Industrial sustainability solutions showcasing energy savings (kWh) and carbon-footprint reduction outcomes.',
      'count': 29,
      'tag': 'Growing',
    },
    {
      ...
      'desc': 'Smart city and digital supply-chain systems emphasizing automation level and interoperability.',
      'count': 57,
      'tag': 'Top Category',
    },
    {
      'name': 'Advanced Manufacturing and Engineering',
      'icon': Icons.foundation_rounded,
      'color': AppColors.sky,
      'desc': 'Region X metals/engineering strengths with production speed and material durability performance indicators.',
      'count': 21,
      'tag': 'Expanding',
    },
    {
      'name': 'Creative Industries and Product Design',
      'icon': Icons.design_services_rounded,
      'color': Color(0xFF7C6AF0),
      'desc': 'Export-ready creative innovations with design-led products, aesthetic quality, and market potential highlights.',
      'count': 33,
      'tag': 'Creative',
    },
  ];
